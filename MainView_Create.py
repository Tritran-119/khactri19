...
class Main_View_Create:
    ...
    def __init__(self):  # Phương thức khởi tạo class
        ...
        self.show_book_button_image = PhotoImage(file=f"./Images/main_view/show_book_button.png")
        ...
        self.logout_button_image = PhotoImage(file=f"./Images/main_view/logout_button.png")
        ...
        self.return_book_button_image = PhotoImage(file=f".Images/main_view/return_book_button.png")
        ...
        self.borrow_book_button_image = PhotoImage(file=f"./Images/main_view/borrow_book_button.png")
        ...
        self.add_book_button_image = PhotoImage(file=f"./Images/main_view/add_book_button.png")
        ...
        self.update_book_button_image = PhotoImage(file=f"./Images/main_view/update_book_button.png")
        ...
        self.remove_book_button_image = PhotoImage(file=f"./Images/main_view/remove_book_button.png")
        ...
        self.update_user_button_image = PhotoImage(file=f"./Images/main_view/update_user_button.png")
